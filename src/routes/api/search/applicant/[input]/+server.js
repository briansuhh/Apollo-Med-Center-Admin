...
export async function GET({ params }) {
    ...
    const columns = [
        'status', 'userID', 'applicantID', 'fullName', 'age', 'gender', 'civilStatus',
        'birthDate', 'birthPlace', 'citizenship', 'homeAddress', 'telephoneNo', 'cellphoneNo',
        'emailAddress', 'tinNo', 'insuranceIDType', 'insuranceIDNo', 'phicNo', 'guardianName',
        'guardianOccupation', 'guardianContactNo', 'collegeAttended', 'degree', 'yearGraduated',
    ...
    const query = `SELECT * FROM applicant WHERE ${whereClause}`;
